<aside class="flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-PinkMuda2 border-r rtl:border-r-0 rtl:border-l">
    <p class="font-zenOldMincho text-black text-2xl text-center m-auto p-2">QuickPay</p>
    </a>
        ...
        <nav class="-mx-3 space-y-1">
            <div class="space-y-1">
                ...
                <div class="flex items-center px-3 py-2">
                    ...
                    <label class="px-3 text-md text-gray-400 font-zenMaruGothic font-bold uppercase">Management
                        Menu</label>
                </div>

                <a class="{{ request()->is('product') ? 'bg-PinkTua rounded-lg text-white font-bold' : 'bg-none transition-colors duration-300 transform rounded-lg hover:bg-PinkSelect hover:text-gray-200' }} flex items-center px-3 py-2 ml-8 mr-8 text-gray-400"
                    href="/product">
                    <span class="mx-2 text-sm font-semibold font-zenMaruGothic">Product</span>
                </a>

                <a class="flex items-center px-3 py-2 ml-8 mr-8 text-gray-400 {{ request()->is('product_category') ? 'bg-PinkTua rounded-lg text-white font-bold' : 'bg-none transition-colors duration-300 transform rounded-lg hover:bg-PinkSelect  hover:text-gray-200' }}"
            ...
            <div class="space-y-1 ">
                ...
                <div class="flex items-center px-3 py-2">
                    ...
                    <label class="px-3 text-md text-gray-400 font-zenMaruGothic font-bold uppercase">Sales
                        Transaction</label>
                </div>

                <a class="flex items-center px-3 py-2 ml-8 mr-8 text-gray-400 {{ request()->is('order') ? 'bg-PinkTua rounded-lg text-white font-bold' : 'bg-none transition-colors duration-300 transform rounded-lg hover:bg-PinkSelect hover:text-gray-200' }}"
                    href="/order">
            ...
            <div class="space-y-1 ">
                ...
                <a class="flex items-center px-3 py-2 ml-8 mr-8 text-gray-400 {{ request()->is('sales-report') ? 'bg-PinkTua rounded-lg text-white font-bold' : 'bg-none transition-colors duration-300 transform rounded-lg hover:bg-PinkSelect hover:text-gray-200' }}"
                    href="/sales-report">
            ...
            <div class="space-y-1 ">
                ...
                <div class="flex items-center px-3 py-2">
                    ...
                    <label class="px-3 text-md text-gray-400 font-zenMaruGothic font-bold uppercase">Purchase</label>
                </div>

                <a class="flex items-center px-3 py-2 ml-8 mr-8 text-gray-400 {{ request()->is('purchase-of-goods') ? 'bg-PinkTua rounded-lg text-white font-bold' : 'bg-none transition-colors duration-300 transform rounded-lg hover:bg-PinkSelect hover:text-gray-200' }}"
