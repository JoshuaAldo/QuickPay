...
<body class="bg-gradient-to-b from-blueRevamp to-blueRevamp2  font-zenOldMincho">
    ...
    <div class="flex items-center justify-center min-h-screen">
        <div class="w-full sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-lg mx-auto px-4 py-16">
            ...
            <form action="{{ route('login.submit') }}" method="post" class="mx-auto mb-0 mt-8 max-w-md space-y-6">
                ...
                <div class="flex items-center justify-center w-full">
                    <button type="submit"
                        class="inline-block rounded-lg bg-blueRevamp text-white px-5 py-3 text-lg font-bold w-32">
                        LOGIN
                    </button>
                </div>
            </form>
